...
import { AboutSection } from "../aboutMe/style";
          ...
          <ContactSectionContent ref={ref}>
            ...
            <ContactsCards>
              <ContactCard>
                <ContactCardContent>
                  <Text color="grey2" type="body2">
                    Este sou eu, Sempre atraído pelas novidades tecnológicas,
                    como a maioria de nós, primeiro aprendi a quebrar coisas,
                    depois aprendi a consertar coisas, mas diferente de muitos
                    agora com a programação finalmente aprendi a criar coisas
                    que ajudam na vida pessoal ou corporativa, muitas vezes
                    facilitando a vida de muitos com um simples toque ou clique.
                    Ademir T Guilherme
                  </Text>
                </ContactCardContent>
              </ContactCard>
